# This implementation is based on the SwinIR model proposed in:
# Liang, Jingyun, et al. "SwinIR: Image Restoration Using Swin Transformer."
# arXiv preprint arXiv:2108.10257 (2021). https://arxiv.org/abs/2108.10257
#
...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=6,
        ...
        elif self.upsampler == 'pixelshuffle_holo':
            self.conv_before_upsample = nn.Sequential(nn.Conv2d(embed_dim, num_feat*2, 3, 1, 1),
                                                      nn.LeakyReLU(inplace=True))
            self.upsample = Upsample(upscale, num_feat * 2)
